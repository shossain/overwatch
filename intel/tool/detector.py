...
class Detector:
    ...
    @torch.no_grad()
    def run_grounding(self, origin_frame, grounding_caption, box_threshold, text_threshold, verbose=False):
        '''
            return:
        ...
        return annotated_frame, transfered_boxes, phrases, logits
